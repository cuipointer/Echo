...
#### Sprint 2 候选(2026-05 下半月)

三条路线视现场条件决策:

| 路线 | 触发条件 | 重点任务 | 预期工时 |
|---|---|---|---|
| **A. v0.9 → v1.0 实测升级** | 有新项目可穿插复测 | 把 LLB-07 / W24-03 / LHB-04 的 v0.9 方法论版升到 v1.0 实测验证版,沉淀案例 | 3 人天(需现场) |
| **B. 继续 P1 SOP 填充** | 现场不便,但方法论足够推导 | NORMAL-05~08 RF 类 / W24-04~07 / LLB-01/03/05/06 等,挑 5-8 个 | 10 人天 |
| **C. Phase 3 自动化序章** | 维护工作量已显现 | linter 接入 PostToolUse hook;case→SOP 自动化 skill MVP;矩阵覆盖度报告 | 3-5 人天 |

**Phase 2 整体成功标准**:
- 27 个 stub 中至少 15 个转为已完成(含 3 个 P0)—— 当前 3/15(Sprint 1 贡献 v0.9 算已完成)
- 案例库 ≥ 8 —— 当前 4/8
...
| 指标 | v2.0.0(2026-04-27) | v2.1.0(2026-05-06) | 6 个月目标 | 12 个月目标 |
|---|:---:|:---:|:---:|:---:|
| 已完成 SOP 数(含 v0.9 方法论版) | 14 | **17**(+LLB-07 / W24-03 / LHB-04) | 30 | 41 + 扩展 |
| 案例库 | 1 | **4** | 15 | 40 |
| 方法论文档 | 4 | **5** | 6 | 8+ |
| matrix.yaml sources | 15 | **16** | 18 | 20+ |
| matrix.yaml mappings | 47 | **49** | 60 | 80+ |
| 架构 linter 检查项 | 9 | 9 | 12 | 15(含 CI 集成) |
